...
def suggest_menu(occasion: str) -> str:
    """
    Suggests a menu based when the occasion is mentioned. For example: 
     - I'm having a casual party, what we can have?.
     - If you're having a formal party, what would you like?.
    Args:
        occasion: single word, The type of occasion for the party. examples:
            casual
            formal
            superhero
    """
...
if __name__ == "__main__":
    ...
    manager_agent.run("Suggest all the plates and drinks for a menu for the party in formal ocasion.")
